...
public class MyCharge {
	...
	public MyCharge(int r_num, String cm_div, Date cm_date, int cm_use, String cm_note, int c_money, int c_point) {
		super();
		this.r_num = r_num;
		this.cm_div = cm_div;
	...
	public String toString() {
		return "MyCharge [r_num=" + r_num + ", cm_div=" + cm_div + ", cm_date=" + cm_date + ", cm_use=" + cm_use
				+ ", cm_note=" + cm_note + ", c_money=" + c_money + ", c_point=" + c_point + "]";
	}
