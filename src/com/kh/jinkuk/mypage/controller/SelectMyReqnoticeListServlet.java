...
/**
 * Servlet implementation class SelectMyReqnoticeListServlet
 */
@WebServlet("/reqList.mp")
public class SelectMyReqnoticeListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public SelectMyReqnoticeListServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//내가 올린  게시글 수 조회
		int listCount = ms.getListCountReqnotice(uno);
		//총 페이지 수 계산
		...
		ArrayList<MyR_M_article> list = new MypageService().selectRequestNoticeList(currentPage, limit,uno);
		
		
		
		String page = "";
		if(list != null) {
			page = "views/mypage/D_delrequestList.jsp";
