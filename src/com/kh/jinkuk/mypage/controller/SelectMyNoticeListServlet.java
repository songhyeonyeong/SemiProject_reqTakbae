...
/**
 * Servlet implementation class SelectMyNoticeList
 */
@WebServlet("/selectMyNoticeList.mp")
public class SelectMyNoticeListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SelectMyNoticeListServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String page = "";
		if(list != null) {
			page = "views/mypage/deliList.jsp";
