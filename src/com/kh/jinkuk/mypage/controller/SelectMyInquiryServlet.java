...
/**
 * Servlet implementation class SelectMyInquiryServlet
 */
@WebServlet("/SelectMyInquiry.mp")
public class SelectMyInquiryServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SelectMyInquiryServlet() {
        super();
...
//		BoardService bs = new BoardService();
		...
		ArrayList<Inquiry> list = new MypageService().selectListInMp(currentPage,limit,uno);
		String page="";
		if(list != null) {
			page="/views/mypage/myQnaList.jsp";
