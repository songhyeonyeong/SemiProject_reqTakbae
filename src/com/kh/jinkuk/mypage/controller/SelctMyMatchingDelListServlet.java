...
/**
 * Servlet implementation class SelctMyMatchingDelListServlet
 */
@WebServlet("/matchingdellist.mp")
public class SelctMyMatchingDelListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SelctMyMatchingDelListServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String page = "";
		if(list != null) {
			page = "views/mypage/D_MatchingDelList.jsp";
