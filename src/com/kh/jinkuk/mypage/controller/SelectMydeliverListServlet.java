...
@WebServlet("/SelectMydeliverlist.mp")
public class SelectMydeliverListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SelectMydeliverListServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//내가 올린  게시글 수 조회
		int listCount = ms.getListCountMOK(uno);
		//총 페이지 수 계산
		...
		ArrayList<MyDeliverNotice> list = new MypageService().selectDevilerList(currentPage, limit,uno);
		
		
		
		String page = "";
		if(list != null) {
			page = "views/mypage/uMatchingDeliList.jsp";
