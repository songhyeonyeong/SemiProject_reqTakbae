...
/**
 * Servlet implementation class SelectJoinCorfirmServlet
 */
@WebServlet("/select.jo")
public class SelectJoinCorfirmServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SelectJoinCorfirmServlet() {
        super();
...
//		BoardService bs = new BoardService();
		...
		//전체 게시글 수 조회
		int listCount = ns.getListCount4();
		...
		ArrayList<Admin> list = new AdminService().selectJoinList(currentPage,limit);
		System.out.println(list);
		String page="";
		if(list != null) {
			page="/views/admin/joinConfirmList.jsp";
