...
/**
 * Servlet implementation class SelectInquiryServlet
 */
@WebServlet("/selectAll.in")
public class SelectInquiryServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SelectInquiryServlet() {
        super();
...
//		BoardService bs = new BoardService();
		...
		ArrayList<Inquiry> list = new AdminService().selectListIn(currentPage,limit);
		System.out.println(list);
		String page="";
		if(list != null) {
			page="/views/admin/qnaList.jsp";
