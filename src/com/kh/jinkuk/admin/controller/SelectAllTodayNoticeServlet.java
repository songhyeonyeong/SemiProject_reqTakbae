...
/**
 * Servlet implementation class SelectAllTodayNoticeServlet
 */
@WebServlet("/selectAll.to")
public class SelectAllTodayNoticeServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SelectAllTodayNoticeServlet() {
        super();
...
//		BoardService bs = new BoardService();
		...
		//전체 게시글 수 조회
		int listCount = ns.getListCountTo();
		...
		ArrayList<Announcment> list = new AdminService().selectListTo(currentPage,limit);
		System.out.println(list);
		String page="";
		if(list != null) {
			page="/views/admin/todayNoticeList.jsp";
