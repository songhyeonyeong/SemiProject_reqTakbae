...
/**
 * Servlet implementation class SelectAllAnnocementServlet
 */
@WebServlet("/selectAll.an")
...
//		BoardService bs = new BoardService();
		...
		//전체 게시글 수 조회
		int listCount = ns.getListCountAn();
		...
		ArrayList<Announcment> list = new AdminService().selectListAn(currentPage,limit);
		System.out.println(list);
		String page="";
		if(list != null) {
			page="/views/admin/allNoticeList.jsp";
