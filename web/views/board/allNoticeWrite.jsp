...
<%
	String gongdiv = (String) request.getParameter("gongdiv");
%>
		...
		<div id="subContainer">
			<div class="contBox inner">
				...
				<div class="rtv of mt30">
					...
					<form id="insertano"
						action="<%=request.getContextPath()%>/insert.bo" method="POST"
						encType="multipart/form-data">
						<input type="hidden" name="gongdiv" value=<%=gongdiv%>>
